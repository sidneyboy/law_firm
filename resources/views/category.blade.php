    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                ...
                <form action="{{ route('category_process') }}" method="post">
                    @csrf
                    <div class="card-body">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Category:
                                                            {{ Str::ucfirst($data->category) }}</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="{{ route('category_edit_process') }}" method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <input type="text" name="category_edit" value="{{ ucfirst($data->category) }}" required
                                                                    class="form-control">
